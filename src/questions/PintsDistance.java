...
public class PintsDistance
{
	...
	static interface PointsOnAPlane
	{
	...
	static class PointsOnAPlaneImpl implements PointsOnAPlane
	{
		...
		public ArrayList<Point> findNearest(Point center, int m)
		{
			...
			PriorityQueue<Point> q = new PriorityQueue<Point>(m, new Comparator<Point>()
			{ // max heap
				@Override
				public int compare(Point a, Point b)
				{
					return Double.compare(b.getDistFromCenter(), a.getDistFromCenter());
				}
			});
			for (Point p : points)
			{
